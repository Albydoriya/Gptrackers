...
const StatusTracker: React.FC = () => {
  ...
  // Refresh component when orders are updated
  React.useEffect(() => {
    const interval = setInterval(() => {
      setRefreshKey(prev => prev + 1);
    }, 5000); // Refresh every 5 seconds to show latest status updates
    ...
    <div className="space-y-6">
            ...
            <button
              ...
              className={`p-4 rounded-lg border transition-all duration-200 transform hover:scale-105 ${
                isActive 
                  ...
                  : 'border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 hover:border-gray-300 dark:hover:border-gray-500'
              }`}
            >
      ...
      {filteredOrders.length === 0 && (
        <div className="text-center py-12 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
          ...
          <p className="text-gray-600 dark:text-gray-400">Try adjusting your search criteria or status filter.</p>
        </div>
      )}
    </div>
  );
