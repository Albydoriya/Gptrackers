        ...
        <div className="p-6 border-b border-gray-200 flex-shrink-0">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900">Bulk Reassign Parts</h3>
                ...
                {filteredParts.map((part) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-medium text-gray-900 truncate">{part.part_number}</p>
                      <p className="text-sm text-gray-600 truncate">{part.name}</p>
                    </div>
                    <div className="flex-shrink-0">
                      <span className="text-sm text-gray-500">Stock: {part.current_stock}</span>
                    </div>
                  </label>
                ))}
              </div>
