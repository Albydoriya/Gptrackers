...
const CreateOrder: React.FC<CreateOrderProps> = ({ isOpen, onClose, onOrderCreated }) => {
  ...
  const handleSubmit = (status: 'draft' | 'supplier_quoting') => {
    createOrderInSupabase(status);
  };

  const createOrderInSupabase = async (status: 'draft' | 'supplier_quoting') => {
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          {currentStep === 1 && (
            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Select Parts for Order</h3>
                ...
                <div className="flex flex-col md:flex-row gap-4 mb-6">
                  <div className="flex-1 relative">
                    ...
                    <input
                      ...
                      className="pl-10 pr-4 py-2 w-full border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-400"
                    />
                  </div>
                  <select
                        ...
                        <div className="grid grid-cols-1 gap-3">
                          <div className="grid grid-cols-2 gap-2">
                            <input
                              ...
                              className="px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-400"
                            />
                            <input
                              type="number"
                              placeholder="Price"
          ...
          {currentStep === 2 && (
            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Choose Supplier</h3>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                        readOnly
                      />
                    </div>
                  </div>
          ...
          {currentStep === 4 && (
            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Review Order</h3>
                  ...
                  <div>
                    ...
                    <div className="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
                      {formData.parts.map((orderPart, index) => (
                        <div key={orderPart.id} className={`p-4 ${index < formData.parts.length - 1 ? 'border-b border-gray-100 dark:border-gray-600' : ''} bg-white dark:bg-gray-800`}>
