        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">{statistics.total_parts_categorized}</p>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-sm text-gray-600">Avg Parts per Category</p>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {filteredCategories.map((category, index) => (
                  <tr
                    ...
                    } ${!category.is_active ? 'bg-gray-50' : 'hover:bg-gray-50'} transition-colors`}
                  >
                    {isAdmin && (
                    ...
                    <td className="px-4 py-4 text-right">
                      <div className="flex items-center justify-end space-x-2">
                        ...
                        <span className="text-sm font-medium text-gray-900">{category.part_count}</span>
                      </div>
                    </td>
                    <td className="px-4 py-4 text-right">
                      <div className="flex items-center justify-end space-x-2">
                    ...
                    <td className="px-4 py-4 text-right">
                      <span className={`text-sm font-medium ${
                        category.low_stock_count > 0 ? 'text-red-600' : 'text-gray-900'
                      }`}>
