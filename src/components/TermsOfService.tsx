    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <main className="max-w-4xl mx-auto px-6 py-8">
        <header className="text-center mb-12 pb-8 border-b-2 border-gray-200 dark:border-gray-700">
          ...
          <p className="text-gray-600 dark:text-gray-400 text-sm italic">Last Updated: January 21, 2026</p>
        </header>

        <section className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-10 mb-8">
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">1. Agreement to Terms</h2>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-10 mb-4">2. Description of Service</h2>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">
            GoParts is an invitation-only business application designed to help authorized personnel manage:
          </p>
          <ul className="mb-6 ml-6 space-y-2 text-gray-900 dark:text-gray-300">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-10 mb-4">3. Eligibility and Account Access</h2>

          <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">3.1 Invitation-Only Access</h3>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">
          ...
          <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">3.2 Google OAuth Authentication</h3>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">
          ...
          <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">3.3 Account Responsibilities</h3>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">You agree to:</p>
          <ul className="mb-6 ml-6 space-y-2 text-gray-900 dark:text-gray-300">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-10 mb-4">4. Acceptable Use Policy</h2>

          <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">4.1 Permitted Uses</h3>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">You may use GoParts only for legitimate business purposes related to:</p>
          <ul className="mb-6 ml-6 space-y-2 text-gray-900 dark:text-gray-300">
          ...
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">You agree NOT to:</p>
          <ul className="mb-6 ml-6 space-y-2 text-gray-900 dark:text-gray-300">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-10 mb-4">5. Intellectual Property Rights</h2>

          <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">5.1 Application Ownership</h3>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">
          ...
          <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">5.2 Limited License</h3>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">
          ...
          <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">5.3 User-Generated Content</h3>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-10 mb-4">6. Data Accuracy and Responsibility</h2>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">You are responsible for:</p>
          <ul className="mb-6 ml-6 space-y-2 text-gray-900 dark:text-gray-300">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-10 mb-4">7. Service Availability and Modifications</h2>

          <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">7.1 Service Availability</h3>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">
          ...
          <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">7.2 Modifications to Service</h3>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-10 mb-4">8. Disclaimers and Limitation of Liability</h2>

          <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">8.1 "As Is" Disclaimer</h3>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">
          ...
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">We do not warrant that:</p>
          <ul className="mb-6 ml-6 space-y-2 text-gray-900 dark:text-gray-300">
          ...
          <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">8.2 Limitation of Liability</h3>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-10 mb-4">9. Indemnification</h2>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-10 mb-4">10. Third-Party Services</h2>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">
          ...
          <ul className="mb-6 ml-6 space-y-2 text-gray-900 dark:text-gray-300">
            <li className="leading-relaxed"><a href="https://policies.google.com/terms" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 underline">Google Terms of Service</a></li>
            <li className="leading-relaxed"><a href="https://supabase.com/terms" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 underline">Supabase Terms of Service</a></li>
          </ul>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">
            We are not responsible for the practices or policies of these third-party services.
          </p>

          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-10 mb-4">11. Termination</h2>

          <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">11.1 Termination by Us</h3>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">
          ...
          <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">11.2 Effect of Termination</h3>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-10 mb-4">12. Data Backup and Export</h2>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-10 mb-4">13. Governing Law and Dispute Resolution</h2>

          <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">13.1 Governing Law</h3>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">
          ...
          <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">13.2 Dispute Resolution</h3>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">
            Any disputes arising out of or relating to these Terms or your use of GoParts shall be resolved through:
          </p>
          <ol className="mb-6 ml-6 space-y-2 list-decimal text-gray-900 dark:text-gray-300">
          ...
          <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">13.3 Class Action Waiver</h3>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-10 mb-4">14. General Provisions</h2>

          <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">14.1 Entire Agreement</h3>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">
          ...
          <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">14.2 Severability</h3>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">
            If any provision of these Terms is found to be invalid or unenforceable, the remaining provisions will remain in full force and effect.
          </p>

          <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">14.3 Waiver</h3>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">
            Our failure to enforce any right or provision of these Terms will not be considered a waiver of those rights.
          </p>

          <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">14.4 Assignment</h3>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">
            You may not assign or transfer these Terms or your rights under these Terms without our prior written consent. We may assign these Terms without restriction.
          </p>

          <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">14.5 Force Majeure</h3>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-10 mb-4">15. Contact Information</h2>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">
            If you have any questions about these Terms of Service, please contact us at:
          </p>
          <div className="bg-gray-50 dark:bg-gray-700 border-l-4 border-blue-600 p-6 my-6 rounded">
            <p className="mb-2 leading-relaxed text-gray-900 dark:text-gray-300"><strong>Email:</strong> <a href="mailto:accounts@go-parts.com.au" className="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300">accounts@go-parts.com.au</a></p>
            <p className="leading-relaxed text-gray-900 dark:text-gray-300"><strong>Subject Line:</strong> GoParts Terms of Service Inquiry</p>
          </div>

          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-10 mb-4">16. Acknowledgment</h2>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">
      ...
      <footer className="bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 py-8 mt-16">
        <div className="max-w-4xl mx-auto px-6">
          <div className="flex justify-between items-center flex-wrap gap-4">
            <p className="text-gray-600 dark:text-gray-400 text-sm">&copy; 2026 GoParts. All rights reserved.</p>
