    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <main className="max-w-4xl mx-auto px-6 py-8">
        ...
        <section className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-10 mb-8">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-10 mb-4">2. Information We Collect</h2>

          <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">2.1 Information Collected via Google OAuth</h3>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">When you sign in to GoParts using Google OAuth, we collect:</p>
          ...
          <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">2.2 Information You Provide</h3>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">When using GoParts, you may provide:</p>
          <ul className="mb-6 ml-6 space-y-2 text-gray-900 dark:text-gray-300">
          ...
          <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">2.3 Automatically Collected Information</h3>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">We automatically collect certain information when you use GoParts:</p>
          <ul className="mb-6 ml-6 space-y-2 text-gray-900 dark:text-gray-300">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-10 mb-4">3. How We Use Your Information</h2>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">We use the collected information for the following purposes:</p>
          <ul className="mb-6 ml-6 space-y-2 text-gray-900 dark:text-gray-300">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-10 mb-4">4. Data Storage and Security</h2>

          <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">4.1 Data Storage</h3>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">
          ...
          <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">4.2 Security Measures</h3>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">We implement various security measures to protect your information:</p>
          <ul className="mb-6 ml-6 space-y-2 text-gray-900 dark:text-gray-300">
          ...
          <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">4.3 Data Retention</h3>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-10 mb-4">5. Invitation-Only Access</h2>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-10 mb-4">6. Information Sharing and Disclosure</h2>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">We do not sell, trade, or rent your personal information to third parties. We may share your information only in the following circumstances:</p>
          <ul className="mb-6 ml-6 space-y-2 text-gray-900 dark:text-gray-300">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-10 mb-4">7. Third-Party Services</h2>

          <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">7.1 Google OAuth</h3>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">
            We use Google OAuth 2.0 for authentication. When you sign in with Google, Google's privacy policy applies to the authentication process. Please review <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 underline">Google's Privacy Policy</a> for more information.
          </p>

          <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-3">7.2 Supabase</h3>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">
            We use Supabase for database hosting and backend services. Please review <a href="https://supabase.com/privacy" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 underline">Supabase's Privacy Policy</a> for information about how they handle data.
          </p>

          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-10 mb-4">8. Your Rights and Choices</h2>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">Depending on your location, you may have certain rights regarding your personal information:</p>
          <ul className="mb-6 ml-6 space-y-2 text-gray-900 dark:text-gray-300">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-10 mb-4">9. Data for Business Purposes</h2>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-10 mb-4">10. Children's Privacy</h2>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-10 mb-4">11. International Data Transfers</h2>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-10 mb-4">12. Changes to This Privacy Policy</h2>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-10 mb-4">13. Contact Us</h2>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">If you have questions, concerns, or requests regarding this Privacy Policy or our data practices, please contact us at:</p>
          <div className="bg-gray-50 dark:bg-gray-700 border-l-4 border-blue-600 p-6 my-6 rounded">
            ...
            <p className="leading-relaxed text-gray-900 dark:text-gray-300"><strong>Subject Line:</strong> GoParts Privacy Policy Inquiry</p>
          </div>

          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-10 mb-4">14. Acceptance of This Policy</h2>
          <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-300">
